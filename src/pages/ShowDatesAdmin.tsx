...
import { CalendarDays, MapPin, Clock, Trash2, RefreshCcw, Info, Search } from "lucide-react";
...
const ShowDatesAdmin: React.FC = () => {
    ...
    const [searchDate, setSearchDate] = useState<string>(""); // formato dd/MM/yyyy
    ...
    useEffect(() => {
        ...
        const filtered = showDates.filter(show =>
            show.city.toLowerCase().includes(term) ||
            show.venueName.toLowerCase().includes(term) ||
            ...
            <div className="w-full max-w-7xl">
                ...
                <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-[#243f4a]">Fechas de Shows</h1>
                    ...
                    <div className="relative w-full md:w-64">
                        <input
                            type="text"
                            placeholder="Buscar por ciudad, fecha o venue..."
                            value={searchTerm}
                ...
                <div className="bg-white/80 backdrop-blur-sm border border-gray-100 rounded-3xl shadow p-6 mb-10">
                    ...
                    <p className="text-4xl font-bold text-[#2fa79a] mt-2">{filteredDates.length}</p>
                </div>
        ...
        `}
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-600 mt-4">
                                    {show.venueName.charAt(0).toUpperCase() + show.venueName.slice(1)}
                                </p>
                ...
                <p className="text-xs text-gray-400 text-center mt-10">Sistema de administración</p>
            </div>
        </div>
    );
};
