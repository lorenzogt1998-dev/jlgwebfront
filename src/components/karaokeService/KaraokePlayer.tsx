...
export default function KaraokePlayer({
  ...
  return (
    ...
    <div ref={fullscreenRef} className={isFullscreen ? "karaoke-fs" : ""}>
                ...
                <div className="rounded-3xl border border-yellow-500/20 bg-gradient-to-r from-slate-900/70 via-slate-950/70 to-slate-900/70 p-4 md:p-5">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      {/* ✅ Fullscreen (tipo YouTube) */}
                      <button
                        type="button"
                        onClick={toggleFullscreen}
                        className="inline-flex items-center justify-center rounded-full border border-slate-600/60 p-2.5 text-slate-200 hover:bg-white/5 transition"
                        title={
